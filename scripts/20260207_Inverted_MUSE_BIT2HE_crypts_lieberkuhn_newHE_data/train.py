...
def parse_cmdargs():
    parser = argparse.ArgumentParser(
        description = '20260207_Inverted_MUSE_BIT2HE_crypts_lieberkuhn_train_HighPass_data'
    )
...
def get_transfer_preset(cmdargs):
    ...
    base_model = (
        '/home/durrlab/Desktop/Anthony/UGVSM/UVCGANv2_vHE/scripts/20260207_Inverted_MUSE_BIT2HE_crypts_lieberkuhn_newHE_data/outdir/20260207_Inverted_MUSE_BIT2HE_crypts_lieberkuhn_pretrain_HighPass_data/model_m(autoencoder)_d(None)_g(vit-modnet)_pretrain-uvcgan2/'
    )
...
# args
    ...
    'outdir' : os.path.join(ROOT_OUTDIR, '20260207_Inverted_MUSE_BIT2HE_crypts_lieberkuhn_newHE_HighPass_data_train'),
    'log_level'  : 'DEBUG',
    'checkpoint' : 10,
}
