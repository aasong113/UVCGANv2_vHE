...
def parse_cmdargs():
    parser = argparse.ArgumentParser(
        description = '20251124_Inverted_Combined_BIT2HE_tumor_kidney_all_Pretrain'
    )
    parser.add_argument(
        '--root_data_path',
        type=str,
...
# args
    ...
    'outdir'     : os.path.join(ROOT_OUTDIR, '20251124_Inverted_Combined_BIT2HE_tumor_kidney_all_Pretrain'),
    'log_level'  : 'DEBUG',
    'checkpoint' : 5,
}
