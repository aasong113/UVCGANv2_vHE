...
def parse_cmdargs():
    parser = argparse.ArgumentParser(
        description = '20251124_Inverted_Combined_BIT2HE_tumor_kidney_all_Train'
    )
...
def get_transfer_preset(cmdargs):
    ...
    base_model = (
        '/home/durrlab/Desktop/Anthony/UGVSM/UVCGANv2/outdir/20251124_Inverted_Combined_BIT2HE_tumor_kidney_all_Pretrain/'
    ...
    'data' : {
        'datasets' : [
            {
                ...
                'name': 'cyclegan',
                'domain': 'A',
                'path': os.path.join(cmdargs.root_data_path, 'kidney_tumor_combined_BIT-invBIT-BIT_trainA'),
            },
            'shape': (3, 512, 512),
            'transform_train': [
        ...
        },
        {
            'dataset': {
                'name': 'cyclegan',
                'domain': 'B',
                'path': os.path.join(cmdargs.root_data_path, 'kidney_tumor_FFPE_HE_trainB'),
            },
            'shape': (3, 512, 512),
            'transform_train': [
                { 'name': 'resize',          'size': 512 },
