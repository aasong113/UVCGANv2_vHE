...
def parse_cmdargs():
    parser = argparse.ArgumentParser(
        description = '20260108_Inverted_combined_BIT2HE_muscularis-submucosa_pretrain'
    )
    parser.add_argument(
        '--root_data_path',
        type=str,
...
# args
    ...
    'outdir'     : os.path.join(ROOT_OUTDIR, '20260108_Inverted_combined_BIT2HE_muscularis-submucosa_pretrain'),
    'log_level'  : 'DEBUG',
    'checkpoint' : 25,
}
