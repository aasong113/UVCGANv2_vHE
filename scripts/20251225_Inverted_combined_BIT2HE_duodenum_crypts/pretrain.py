...
def parse_cmdargs():
    parser = argparse.ArgumentParser(
        description = '20251225_Inverted_combined_BIT2HE_duodenum_crypts_pretrain'
    )
    parser.add_argument(
        '--root_data_path',
        type=str,
...
# args
    ...
    'outdir'     : os.path.join(ROOT_OUTDIR, '20251225_Inverted_combined_BIT2HE_duodenum_crypts_pretrain'),
    'log_level'  : 'DEBUG',
    'checkpoint' : 50,
}
