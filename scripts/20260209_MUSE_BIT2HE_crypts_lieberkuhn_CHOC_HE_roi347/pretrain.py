...
def parse_cmdargs():
    parser = argparse.ArgumentParser(
        description = '20260207_Inverted_MUSE_BIT2HE_crypts_lieberkuhn_pretrain_CHOC_HE_roi347'
    )
    parser.add_argument(
        '--root_data_path',
        type=str,
...
# args
    ...
    'outdir'     : os.path.join(ROOT_OUTDIR, '20260207_Inverted_MUSE_BIT2HE_crypts_lieberkuhn_pretrain_CHOC_HE_roi347'),
    'log_level'  : 'DEBUG',
    'checkpoint' : 25,
}
