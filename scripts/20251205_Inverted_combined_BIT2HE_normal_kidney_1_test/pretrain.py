...
def parse_cmdargs():
    parser = argparse.ArgumentParser(
        description = '20251130_Inverted_Combined_BIT2HE_normal_kidney_1_Pretrain'
    )
    parser.add_argument(
        '--root_data_path',
        type=str,
        ...
        'datasets' : [
            {
                ...
                'name': 'cyclegan',
                'domain': 'A',
                'path': os.path.join(cmdargs.root_data_path, 'combined_normalized_BIT-invBIT-BIT'),
            },
            'shape': (3, 512, 512),
            'transform_train': [
...
# args
    ...
    'outdir'     : os.path.join(ROOT_OUTDIR, "20251130_Inverted_Combined_BIT2HE_normal_kidney_1_Pretrain"),
    'log_level'  : 'DEBUG',
    'checkpoint' : 5,
}
