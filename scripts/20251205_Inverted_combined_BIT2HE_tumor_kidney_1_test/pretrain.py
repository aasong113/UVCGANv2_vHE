...
def parse_cmdargs():
    parser = argparse.ArgumentParser(
        description = '20251205_Inverted_Combined_BIT2HE_tumor_kidney_1_Pretrain'
    )
    parser.add_argument(
        '--root_data_path',
        type=str,
...
# args
    ...
    'outdir'     : os.path.join(ROOT_OUTDIR, '20251205_Inverted_Combined_BIT2HE_tumor_kidney_1_Pretrain'),
    'log_level'  : 'DEBUG',
    'checkpoint' : 5,
}
