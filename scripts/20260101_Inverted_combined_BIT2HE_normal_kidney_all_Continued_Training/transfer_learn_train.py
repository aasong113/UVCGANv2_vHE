...
def parse_cmdargs():
    parser = argparse.ArgumentParser(
        description = '20260102_Inverted_combined_BIT2HE_normal_kidney_transfer_learn'
    )
...
def get_transfer_preset(cmdargs):
    ...
    base_model = (
        '/home/durrlab/Desktop/Anthony/UGVSM/UVCGANv2_new/outdir/'
        '20251201_Inverted_Combined_BIT2HE_normal_kidney_all/'
        '20251201_Inverted_Combined_BIT2HE_normal_kidney_all_Train'
    )

    return {
        'base_model': base_model,
        'transfer_map': {
            'gen_ab': 'avg_gen_ab',  # ← use EMA generator
            'gen_ba': 'avg_gen_ba',
        },
        'strict': True,
        'allow_partial': False,
...
# args
    ...
    'outdir' : os.path.join(ROOT_OUTDIR, '20260102_Inverted_combined_BIT2HE_normal_kidney_transfer_learn'),
    'log_level'  : 'DEBUG',
    'checkpoint' : 10,
}
